...
class StoreCreateNetDevice extends FormRequest
{
    ...
    public function messages()
    {
        ...
        'ipaddr.required' => 'Il campo IP Address non può essere vuoto',
        'ipaddr.ipv4' => 'Il campo IP Address non è nel formato corretto',
        'netmask.required' => 'Il campo Netmask non può essere vuoto se hai indicato l\'IP Address',
        ...
        'name.composite_unique' => 'Esiste già un\'interfaccia con questo nome configurata sul sistema',
        'pcislot.composite_unique' => 'Esiste già un\'interfaccia con questo PCI slot configurata sul sistema',
        ];
